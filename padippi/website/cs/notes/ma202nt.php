...
<script>
  ...
  <title> KTU MA202 Probability Distribution, Transform and Numerical full notes, module wise notes</title>
  <meta charset="utf-8">
              ...
              <div class="conta"><hr>
                ...
                <div class="col">
                  <div class="container_pdtn">
                    ...
                    $select = "SELECT * FROM `s4ma202` WHERE type='notes' ORDER BY id DESC";
