...
<script>
  ...
  <title> KTU CS206 Object Oriented Design and Programming full notes, module wise notes</title>
  <meta charset="utf-8">
...
<?php
    ...
    if(isset($_POST['fileuploadsubmit']))
    {
        ...
        $type=$_GET['p2'];
        $name=$_GET['p1'];
        $sql = "INSERT INTO `s4cs206`(`name`, `link`, `type`, `Author`) VALUES ('$uname', '$password', '$type', '$name')";
              ...
              <div class="conta"><hr>
                ...
                <div class="col">
                  <div class="container_pdtn">
                    ...
                    $select = "SELECT * FROM `s4cs206` WHERE type='notes' ORDER BY id DESC";
