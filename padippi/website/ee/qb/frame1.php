...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: "ca-pub-1703746112659578",
    enable_page_level_ads: true
  });
</script>

  <title> KTU question bank,full notes & study materials</title>
  <meta charset="utf-8">
...
<ins class="adsbygoogle"
     style="display:block"
     data-ad-client="ca-pub-1703746112659578"
     data-ad-slot="9211852522"
     data-ad-format="auto"
          ...
          <div class="courses_01">
            ...
            <section>
              ...
              <?php
                     ...
                     $image = $_GET['p2'];  
                    ?>
                <h2 class="dept"><?php echo "$txt";?></h2><hr>
                
                  <iframe alt="please wait" height="900" src="https://drive.google.com/file/d/<?php echo "$image";?>/preview" width="640"></iframe><br><br>
                  <a href="https://drive.google.com/uc?export=download&id=<?php echo "$image";?>" target="_blank"><img border="1" height="70" src="../../../images/cap.PNG" width="200"></a>
