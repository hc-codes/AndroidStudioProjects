...
<script>
  ...
  <title> KTU EE208  Measurements and Instrumentation question bank,previous year question paper, solved questions</title>
  <meta charset="utf-8">
      ...
      <div class="inside">
        <div class="address">
          ...
          <div class="courses_01">
            ...
            <section>
              <div class="conta"><hr>
                <h2 class="dept"> Measurements and Instrumentation</h2>
                <div class="col">
                  <div class="container_pdtn">
                    ...
                    $select = "SELECT * FROM `s4ee208` WHERE type='quest' ORDER BY id DESC";
        ...
        <?php
                            //Select all data from `updis` table
                    $select = "SELECT * FROM `s4ee208` WHERE type='module'  ORDER BY id DESC";
                    $query = mysqli_query($conn, $select) ;
                    while($row = mysqli_fetch_array($query)) 
                    {
                        $image = $row['link'];
