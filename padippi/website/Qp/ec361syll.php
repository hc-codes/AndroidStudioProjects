...
<script>
  ...
  <title>EC312 Object oriented programming Syllabus & Textbooks</title>
  <meta charset="utf-8">
...
<div class="wrap">
  <header>
    <div class="conta">
    <a href="http://www.padippi.com"><img src="../../images/logos.jpg" style="width: 64%;position:absolute;top: 64px;"></a>
      <nav>
        <ul>
        <li><a href="http://www.padippi.com" class="m1">Home Page</a></li>
  ...
  <div class="conta">
    <aside>
      ...
      <ul class="categories">
      <li><span><a href="https://www.padippi.com/KTU/ktuindex.php">Kerala Technical University</a></span></li>
        <li><span><a href="https://www.padippi.com/DHSE/ktuindex.php">DHSE</a></span></li>
        <li><span><a href="https://www.padippi.com/UC/ktuindex.php">Calicut University</a></span></li>
...
<br>
      <div class="inside">
        ...
        <img src="../../images/logo-ktu.png" alt="ktu university logo"  style="left: 44%;position: relative;">
            ...
            <h3>PPTs, Solved Questions Papers, Students with Tutors Notes, Answer Keys, Sample Mini and Main Projects..etc</h3>
              </div>
          <div class="courses_01">
            <!-- courses -->
            <section>
              <div class="conta"><hr>
                <h2 class="dept">EC312 Object oriented programming </h2>
                <div class="col">
                  <div class="container_pdtn">
                    <div class="question_bank">
                      <h2 >Textbooks & Syllabus</h2>
                    </div>
                    <iframe alt="please wait" height="900" src="https://drive.google.com/file/d/1Jz4iZ6AkBOMvOq_60dJzlYuGRjph-Wnk/preview" width="640"></iframe><br><br>
                  <a href="https://drive.google.com/uc?export=download&id=1Jz4iZ6AkBOMvOq_60dJzlYuGRjph-Wnk" target="_blank"><img border="1" height="70" src="../../images/cap.PNG" width="200"></a>
...
<footer>
  <div class="footerlink">
    <p class="lf">Copyright &copy; 2019 <a href="#">TechnoclubSolutions Pvt Ltd</a> - All Rights Reserved</p>
